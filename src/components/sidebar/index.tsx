...
const Sidebar  = async({id, type}: Props) => {
    ...
    return (
        <>
            <MenuOptions defaultOpen={true} details={details} id={id} sidebarOpt={sidebarOpt} sidebarLogo={sideBarLogo} subAccounts={subaccounts} user={user}/>
            <MenuOptions details={details} id={id} sidebarOpt={sidebarOpt} sidebarLogo={sideBarLogo} subAccounts={subaccounts} user={user}/>
        </>
    )
}
