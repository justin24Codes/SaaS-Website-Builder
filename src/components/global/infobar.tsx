      ...
      >
        <div className="flex items-center gap-2 ml-auto">
          ...
          <Sheet>
            ...
            <SheetContent className="mt-4 pr-4 flex flex-col overflow-y-auto mb-4">
              <SheetHeader className="text-left">
                <SheetTitle>Notifications</SheetTitle>
                <SheetDescription>
                  {(role === "AGENCY_ADMIN" || role === "AGENCY_OWNER") && (
                    <span className="flex items-center justify-between p-4 border rounded-xl">
                      Current Subaccount
              ...
              {allNotifications?.map((notification) => (
                <div
                  key={notification.id}
                  className="flex flex-col gap-y-2 mb-2 text-ellipsis text-sm"
                >
